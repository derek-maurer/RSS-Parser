...
@synthesize retrieverQueue = _retrieverQueue, totalFileSize;
...
-(BOOL)fetchAndParseRss{
    [(id)[self delegate] performSelectorOnMainThread:@selector(startedParsing)
                                          withObject:nil
                                       waitUntilDone:NO];
	...
	NSURL *url = [NSURL URLWithString:@"http://chcollegeage.com/devotions/feed"];
	BOOL success = NO;
